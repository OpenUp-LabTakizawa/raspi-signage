                ...
                {updateDisplay ? (
                  <>
                    <Grid container>
                        ...
                        <Grid item xs={8} container direction="column" style={{ minWidth: "550px", display: "flex",　flexDirection: "row", alignItems: "center", padding: "20px" }}>
                          <Grid item style={{ display: "flex", height: "45px", padding: "5px", justifyContent: "space-between" }}>
                            <Typography style={{ lineHeight: "35px" }}>パスワード（現在のパスワード）： </Typography>
                            <input
                              type="password"
                              style={{ width: "50%" }}
                              name={"nowPassword"}
                        ...
                        <Grid item xs={8} container direction="column" style={{ minWidth: "550px", display: "flex",　flexDirection: "row", alignItems: "center", padding: "20px" }}>
                          <Grid item style={{ display: "flex", height: "45px", padding: "5px", justifyContent: "space-between" }}>
                            <Typography style={{ lineHeight: "35px" }}>新しいパスワード： </Typography>
                            <input
                              type="password"
                              style={{ width: "50%" }}
                              name={"newPassword"}
                        ...
                        <Grid item xs={8} container direction="column" style={{ minWidth: "550px", display: "flex",　flexDirection: "row", alignItems: "center", padding: "20px" }}>
                          <Grid item style={{ display: "flex", height: "45px", padding: "5px", justifyContent: "space-between" }}>
                            <Typography style={{ lineHeight: "35px" }}>新しいパスワード（再）： </Typography>
                            <input
                              type="password"
                              style={{ width: "50%" }}
                              name={"newRePassword"}
                ...
                (
                 <>
                   <Grid container>
                       ...
                       <Grid item xs={8} container direction="column" style={{ minWidth: "550px", display: "flex",　flexDirection: "row", alignItems: "center", padding: "20px" }}>
                         <Grid item style={{ display: "flex", height: "45px", padding: "5px" }}>
                           <Typography style={{ lineHeight: "35px", display: "flex", flexDirection: "row"}}>エリア設定： {areaList.length > 0 ? (areaList.map((area, i) => (<Grid key={"areList_" + i} style={{ padding: "0 10px" }}>{area}</Grid>))) : (<Grid style={{ padding: "0 10px" }}>設定なし</Grid>)}</Typography>
                         </Grid>
                       </Grid>
                     </Grid>
                 </>
